 ...
 */
function init() {
    //adding function for clear localStorage and reload page
    document.getElementById('clearButton').addEventListener('click', function () {window.localStorage.clear(); location.reload()});
    //adding keyup function to start search
